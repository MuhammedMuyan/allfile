...
public class TextBoxes {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.getProperty("webdriver.chromedriver", "frivers/chromedriver");
	...
	/*	driver.findElement(By.xpath("//input[@name='RESULT_TextField-1']")).sendKeys("Hakan");
		...
		*/
		...
		//2.way code redundancy and reusability
		...
		System.out.println("The value of the class attribute is: " + lname.getAttribute("class"));

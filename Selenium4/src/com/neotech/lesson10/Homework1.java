...
public class Homework1 extends BaseClass {
	...
	public static void main(String[] args) throws InterruptedException {
       ...
       setUp();
	    ...
	    //since we have to click on the row of Susan, I want to get all the rows of the table
		...
		String newName = driver.findElement(By.xpath("//table[@id='ctl00_MainContent_orderGrid']/tbody/tr["+ rowIndex +"]/td[2]")).getText();
